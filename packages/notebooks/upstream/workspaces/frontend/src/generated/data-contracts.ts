...
export interface ApiWorkspaceKindCreateEnvelope {
  data: WorkspacekindsWorkspaceKindCreate;
}

export interface ApiWorkspaceKindEnvelope {
  data: WorkspacekindsWorkspaceKindUpdate;
}

export interface ApiWorkspaceKindListEnvelope {
  data: WorkspacekindsWorkspaceKindListItem[];
}
...
export interface V1Beta1ImageConfig {
  /** spawner ui configs */
  spawner: V1Beta1OptionsSpawnerConfig;
  /**
   ...
   * +listMapKey:="id"
   */
  values: V1Beta1ImageConfigValue[];
}

export interface V1Beta1ImageConfigSpec {
  /**
   ...
   * +listMapKey:="id"
   */
  ports: V1Beta1ImagePort[];
}

export interface V1Beta1ImageConfigValue {
  /**
  ...
  spawner: V1Beta1OptionSpawnerInfo;
  /** the spec of the image config */
  spec: V1Beta1ImageConfigSpec;
}

export interface V1Beta1ImagePort {
  /**
...
export interface V1Beta1OptionRedirect {
   ...
   * +kubebuilder:validation:Optional
   */
  message?: V1Beta1RedirectMessage;
  /**
...
export interface V1Beta1OptionSpawnerInfo {
  /**
   ...
   * +listMapKey:="key"
   */
  labels?: V1Beta1OptionSpawnerLabel[];
}

export interface V1Beta1OptionSpawnerLabel {
  /**
...
export interface V1Beta1OptionsSpawnerConfig {
  /**
...
export interface V1Beta1PodConfig {
  /** spawner ui configs */
  spawner: V1Beta1OptionsSpawnerConfig;
  /**
...
export interface V1Beta1PodConfigValue {
  /**
  ...
  spec: V1Beta1PodConfigSpec;
}

export interface V1Beta1RedirectMessage {
  /**
   * the importance level of the message
   * +kubebuilder:example:="Info"
   */
  level: V1Beta1RedirectMessageLevel;
  /**
...
export interface V1Beta1WorkspaceKindPodOptions {
  /** imageConfig options */
  imageConfig: V1Beta1ImageConfig;
  /** podConfig options */
